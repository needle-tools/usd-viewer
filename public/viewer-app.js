...
async function init() {
  ...
  */
  ...
  const converterFamilies = [
    ...
    { id: 'original-gltf', aliases: ['original-gltf', 'gltf', 'glb', 'original'], name: 'Original glTF', title: 'Original glTF/GLB source asset' },
  ];
  ...
  function assetExplorerOriginalGltfUrl(model) {
  ...
  function collectAssetExplorerConversions(model) {
    ...
    addConversion(conversions, 'original-gltf', assetExplorerOriginalGltfUrl(model));
    return conversions;
  }
